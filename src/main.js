(() => {
  ...
  const RoomArt = window.Veilbound && window.Veilbound.RoomArt;
  ...
  const KAEL_SHEET = 'kael_chibi', KAEL_SHEET_FALLBACK = 'kael';
  ...
  const rooms = {
    greyhaven: { name:'GREYHAVEN', ground:'#233128', details:'town', walls:[{x:0,y:0,w:960,h:38},{x:0,y:502,w:960,h:38},{x:0,y:0,w:38,h:540},{x:922,y:0,w:38,h:210},{x:922,y:330,w:38,h:210},{x:90,y:95,w:185,h:105},{x:395,y:60,w:215,h:140},{x:672,y:96,w:70,h:56},{x:762,y:96,w:70,h:56},{x:852,y:96,w:58,h:56},{x:96,y:355,w:180,h:105},{x:560,y:350,w:170,h:105},{x:790,y:330,w:90,h:140}], exits:[{x:920,y:210,w:40,h:120,room:'hollowMarch1',spawnX:62,spawnY:270,entry:'west'},{x:684,y:336,w:46,h:14,room:'hunterHall',spawnX:480,spawnY:448,entry:'south'}], enemies:[], resonanceNodes:[{id:'greyhaven.liftStation',x:502,y:130,radius:62,flag:'greyhaven.liftStationScanned',label:'OLD LIFT STATION'}] },
    forestPath: { name:'THE FOREST PATH', ground:'#141d1a', details:'field2', walls:[{x:0,y:0,w:960,h:38},{x:0,y:502,w:960,h:38},{x:0,y:0,w:38,h:540},{x:922,y:0,w:38,h:205},{x:922,y:335,w:38,h:205},{x:120,y:96,w:96,h:64,hidden:true},{x:404,y:392,w:88,h:56,hidden:true},{x:690,y:104,w:104,h:72,hidden:true}], exits:[{x:920,y:205,w:40,h:130,room:'greyhaven',spawnX:120,spawnY:270,entry:'west'}], enemies:[{id:'prologue.corrupted.01',type:'corrupted',x:648,y:300,persistent:true}], resonanceNodes:[] },
    hunterHall: { name:'GREYHAVEN — HUNTER HALL', ground:'#1a1512', details:'ruin', walls:[{x:0,y:0,w:960,h:74},{x:0,y:466,w:420,h:74},{x:540,y:466,w:420,h:74},{x:0,y:0,w:74,h:540},{x:886,y:0,w:74,h:540},{x:120,y:120,w:150,h:70,hidden:true},{x:690,y:120,w:150,h:70,hidden:true}], exits:[{x:420,y:500,w:120,h:40,room:'greyhaven',spawnX:707,spawnY:318,entry:'north'}], enemies:[], resonanceNodes:[] },
    hollowMarch1: { name:'HOLLOW MARCH — FIELD 1', ground:'#1b2921', details:'field', walls:[{x:0,y:0,w:960,h:38},{x:0,y:502,w:960,h:38},{x:0,y:0,w:38,h:205},{x:0,y:335,w:38,h:205},{x:922,y:0,w:38,h:205},{x:922,y:335,w:38,h:205},{x:478,y:44,w:112,h:126,hidden:true},{x:654,y:92,w:56,h:68,hidden:true},{x:846,y:86,w:58,h:54,hidden:true},{x:672,y:322,w:58,h:44,hidden:true},{x:174,y:420,w:62,h:58,hidden:true},{x:400,y:396,w:50,h:46,hidden:true}], exits:[{x:0,y:205,w:40,h:130,room:'greyhaven',spawnX:895,spawnY:270,entry:'east'},{x:920,y:205,w:40,h:130,room:'hollowMarch2',spawnX:62,spawnY:270,entry:'west'}], enemies:[{id:'march.field1.husk.01',type:'husk',x:675,y:225},{id:'march.field1.husk.02',type:'husk',x:785,y:310}], resonanceNodes:[] },
    hollowMarch2: { name:'HOLLOW MARCH — FIELD 2', ground:'#19251f', details:'field2', walls:[{x:0,y:0,w:960,h:38},{x:0,y:502,w:420,h:38},{x:540,y:502,w:420,h:38},{x:0,y:0,w:38,h:205},{x:0,y:335,w:38,h:205},{x:922,y:0,w:38,h:205},{x:922,y:335,w:38,h:205},{x:472,y:216,w:42,h:36,hidden:true},{x:650,y:314,w:124,h:98,hidden:true},{x:122,y:386,w:78,h:48,hidden:true},{x:810,y:72,w:62,h:50,hidden:true}], exits:[{x:0,y:205,w:40,h:130,room:'hollowMarch1',spawnX:895,spawnY:270,entry:'east'},{x:920,y:205,w:40,h:130,room:'awakeningRuin',spawnX:62,spawnY:270,entry:'west'},{x:420,y:500,w:120,h:40,room:'archiveThreshold',spawnX:480,spawnY:68,entry:'north',requiresFlag:'march.field2.resonanceRouteRevealed'}], enemies:[{id:'march.field2.husk.01',type:'husk',x:390,y:220},{id:'march.field2.sentry.01',type:'sentry',x:760,y:215}], resonanceNodes:[{id:'march.field2.veinMarker',x:712,y:356,radius:46,flag:'march.field2.resonanceRouteRevealed',label:'BURIED VEIN ROUTE'}] },
  ...
  function actionPressed(){if(paused)return;if(Cutscene&&Cutscene.active()&&!dialogueSequence)return;if(dialogueSequence){advanceDialogue();return;}if(interactTarget){interactPressed(interactTarget);return;}attack();}
  ...
  function findInteractTarget(){if(dialogueSequence||player.health<=0||(Cutscene&&Cutscene.active()))return null;let best=null,bestD=Infinity;for(const it of roomInteractables(player.room)){const d=Math.hypot(it.x-player.x,it.y-player.y);if(d>(it.reach||46)+player.radius)continue;if(d<bestD){bestD=d;best=it;}}return best;}
  ...
  function resonancePressed(){if(paused||dialogueSequence||(Cutscene&&Cutscene.active())||!hasAbility('resonance')||resonanceCooldown>0)return;resonanceTimer=.72;resonanceCooldown=1.15;resonanceRadius=0;Audio.sfx('resonance');screenFlash=Math.max(screenFlash,.08);spawnParticles(player.x,player.y,'#7fe7e1',12,90);}
  ...
  function damageEnemy(e){e.lastHitSerial=player.attackSerial;e.hp--;e.flash=.13;e.stun=.16;Audio.sfx(e.hp<=0?'enemyDown':'hit');const dx=e.x-player.x,dy=e.y-player.y,len=Math.hypot(dx,dy)||1;tryMoveEnemy(e,dx/len*18,dy/len*18);spawnParticles(e.x,e.y,'#bdebe1',7,105);screenFlash=Math.max(screenFlash,.045);if(e.hp<=0){if(e.persistent)saveData.world.defeatedEnemies[e.id]=true;if(e.type==='corrupted'&&!hasFlag('prologue.creatureHeard'))setTimeout(()=>playScene(Prologue&&Prologue.creature,{once:'prologue.creatureHeard'}),620);e.dying=deathSeconds(e.type);e.clock=0;Progression.onEnemyDefeated(e);spawnParticles(e.x,e.y,'#7fe7e1',14,135);saveGame('ENEMY CLEARED');}}
  ...
  function setDialoguePortrait(speaker,mood,allowed){
    if(!dialoguePortrait)return;
    if(allowed===false){dialoguePortrait.hidden=true;return;}
  ...
  function playScene(scene,{once=null,then=null}={}){
    if(!Cutscene||!scene)return false;
    if(once&&hasFlag(once))return false;
    if(Cutscene.active())return false;
    if(scene.region)Audio.setRegion(scene.region);
    setCinematicChrome(true);
    Cutscene.play(scene,()=>{
      setCinematicChrome(false);
      if(once){setFlag(once,true);saveGame('AUTOSAVED');}
  ...
  // path has become the thing he is doing rather than the thing he just started.
  function checkPrologueTriggers(){
    if(!Prologue||!Cutscene||Cutscene.active())return;
    if(player.room==='forestPath'&&player.x>320&&!hasFlag('prologue.visionSeen')){
      playScene(Prologue.vision,{once:'prologue.visionSeen'});
    }
  }
  ...
  function drawWorld(ctx){const view=getView(),room=rooms[player.room];ctx.setTransform(1,0,0,1,0,0);ctx.fillStyle='#070a0d';ctx.fillRect(0,0,canvas.width,canvas.height);ctx.save();const shake=Cutscene?Cutscene.offset():{x:0,y:0};ctx.translate(view.offsetX+shake.x,view.offsetY+shake.y);ctx.scale(view.scale,view.scale);const painted=RoomArt&&RoomArt.draw(ctx,player.room);let tiled=false;if(!painted){ctx.fillStyle=room.ground;ctx.fillRect(0,0,WORLD.width,WORLD.height);tiled=drawTerrain(ctx,player.room);drawRoomDetails(ctx,room,tiled);}else if(RoomArt)RoomArt.drawOverlay(ctx,player.room,hasFlag,performance.now()/1000);if(!painted){ctx.fillStyle='#111817';for(const w of room.walls){if(w.hidden)continue;ctx.fillRect(w.x,w.y,w.w,w.h);ctx.strokeStyle='rgba(190,220,210,.08)';ctx.strokeRect(w.x+.5,w.y+.5,w.w-1,w.h-1);}}for(const exit of room.exits){if(!exitAvailable(exit))continue;ctx.fillStyle='rgba(127,231,225,.08)';ctx.fillRect(exit.x,exit.y,exit.w,exit.h);}if(room.details==='town'&&!painted)drawTownOver(ctx);drawRoomMechanisms(ctx,room);drawResonanceNodes(ctx,room);Puzzles.draw(ctx);if(!painted)drawProps(ctx,player.room);drawInteractables(ctx,player.room);Progression.draw(ctx);drawProjectiles(ctx);drawEnemies(ctx);drawParticles(ctx);drawKael(ctx);drawResonancePulse(ctx);if(debugEnabled)drawDebugShapes(ctx,room);ctx.restore();if(screenFlash>0){ctx.fillStyle=`rgba(127,231,225,${Math.min(.34,screenFlash)})`;ctx.fillRect(view.offsetX,view.offsetY,view.drawW,view.drawH);}if(Cutscene)Cutscene.draw(ctx,view);}
  ...
  function drawEnemySprite(ctx,e){const clip=e.hp<=0?'death':e.clip;if(!Sprites.enemyReady(e.type,clip))return false;ctx.fillStyle='rgba(0,0,0,.24)';ctx.beginPath();ctx.ellipse(e.x,e.y+10,17,7,0,0,Math.PI*2);ctx.fill();if(e.flash>0)ctx.globalAlpha=.75;Sprites.drawEnemy(ctx,(EnemyRegistry[e.type]&&EnemyRegistry[e.type].sheet)||e.type,clip,{x:e.x,y:e.y,facingX:e.faceX,facingY:e.faceY,seconds:e.clock});ctx.globalAlpha=1;return true;}
  ...
  function kaelSheet(){return Sprites.ready(KAEL_SHEET,kaelClip())?KAEL_SHEET:KAEL_SHEET_FALLBACK;}
  ...
  function drawKaelSprite(ctx){const clip=kaelClip(),sheet=kaelSheet();if(!Sprites.ready(sheet,clip))return false;const frame=clip==='Walking_A'?player.walkPhase*.9:(clip==='Use_Item'?(.22-player.attackTimer)*22:performance.now()*.004);if(player.invuln>0&&Math.floor(player.invuln*18)%2===0)ctx.globalAlpha=.42;ctx.fillStyle='rgba(0,0,0,.25)';ctx.beginPath();ctx.ellipse(player.x,player.y+14,16,7,0,0,Math.PI*2);ctx.fill();const drawn=Sprites.draw(ctx,sheet,clip,{x:player.x,y:player.y,facingX:player.facingX,facingY:player.facingY,frame,size:KAEL_SPRITE_SIZE});if(drawn&&player.attackTimer>0){const angle=Math.atan2(player.facingY,player.facingX);ctx.strokeStyle='#d9f6ef';ctx.lineWidth=5;ctx.beginPath();ctx.arc(player.x,player.y,44,angle-.72,angle+.72);ctx.stroke();}ctx.globalAlpha=1;return drawn;}
